Steps:
You should be back at your repository homepage
Click "Add file" → "Create new file" (same as before)
In the "Name your file..." box, type: scraper.py
In the big editor, copy and paste this entire script:
#!/usr/bin/env python3
"""
...
ATTACK_KEYWORDS = [
    'attack', 'breach', 'hacked', 'ransomware', 'malware',
    'exploit', 'vulnerability', 'data leak', 'compromise',
    'zero-day', 'backdoor', 'trojan', 'phishing', 'ddos',
    'intrusion', 'penetration', 'incident', 'threat actor',
    'cyber attack', 'security breach', 'exposed', 'stolen data'
]
...
class CyberNewsMonitor:
    ...
    def send_digest_email(self):
        ...
        try:
            ...
            if not articles:
                print("ℹ No new cyberattack articles to send")
                return
    ...
    def generate_digest_html(self, articles, since_date):
        ...
        html += """
            <div class="footer">
                ...
                <p>Stay vigilant and stay secure! 🛡️</p>
            </div>
        </body>
        </html>
        """
